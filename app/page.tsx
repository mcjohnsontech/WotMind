            ...
            <div className="relative flex items-center justify-center gap-3 sm:gap-6 lg:gap-8 h-full overflow-x-auto">
              {[
                ...
                },
                {
                  ...
                  bg: 'bg-node-transfer/10',
                  border: 'border-node-transfer/30',
                  label: 'Pay',
                  sub: 'Via Squad',
                },
                {
                  ...
                  <div key={step.label} className="flex items-center gap-2 sm:gap-4 lg:gap-8 shrink-0">
                    ...
                    >
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        <div
                          className={`w-6 h-6 sm:w-7 sm:h-7 rounded-md flex items-center justify-center ${step.bg}`}
                        >
                    ...
                    {idx < arr.length - 1 && (
                      <div
                        ...
                        style={{
                          animation: `fade-in 0.4s ease ${0.45 + idx * 0.12}s both`,
                        }}
                        aria-hidden="true"
                      />
                    )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 opacity-70">
          {['Squad', 'Gemini', 'Twilio', 'Supabase', 'WhatsApp', 'PostgreSQL'].map((name) => (
            <span
              key={name}
              className="text-sm font-semibold text-text-tertiary tracking-tight"
            >
              {name}
            </span>
          ))}
  ...
  const problems = [
    {
      ...
      description:
        'Naira devaluation and rising costs are squeezing margins. Every leak compounds.',
    ...
    },
    {
      ...
      description:
        'Stockouts cost sales; overstock ties up capital and expires on the shelf.',
      color: 'text-accent-amber',
      bg: 'bg-accent-amber/10',
    },
    {
      icon: Receipt,
      title: 'Fake reimbursements',
      description:
        'Doctored receipts and duplicate claims drain ₦millions every year, undetected.',
    ...
    },
    {
      ...
      description:
        'Manual payroll, VAT, PAYE — one mistake costs more than a year of automation.',
      color: 'text-accent-blue',
      bg: 'bg-accent-blue/10',
    },
    {
      icon: AlertTriangle,
      title: 'Operational leakages',
      description:
        'Slow approvals, duplicate payments, missed renewals — death by a thousand cuts.',
      color: 'text-accent-amber',
      bg: 'bg-accent-amber/10',
    },
    {
      icon: LineChart,
      title: 'Passive fintech',
      description:
        'Dashboards report problems. They don\'t solve them. Your tools are watching, not acting.',
    ...
    <section id="problem" className="py-16 sm:py-24 border-b border-border-subtle">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          <span className="inline-block text-[11px] font-semibold uppercase tracking-widest text-accent-primary mb-3">
            The problem
          </span>
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
            Nigerian businesses are bleeding money
          </h2>
          <p className="text-text-secondary text-base sm:text-lg leading-relaxed">
            Most failures aren&apos;t product failures. They&apos;re operational failures —
            quiet, daily, compounding.
          </p>
        </div>
    ...
    <section id="what-is" className="py-16 sm:py-24 border-b border-border-subtle">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
            Payment rails, reimagined as an AI operating system
          </h2>
          <p className="text-text-secondary text-base sm:text-lg leading-relaxed">
            Squad gives you the rails. Wotmind gives them a brain. Every event, every
            decision, every payout — orchestrated by AI you can trust.
          </p>
        </div>

        {/* Trigger → Logic → Action flow */}
          ...
          {[
            {
              ...
              bg: 'bg-node-trigger/10',
              border: 'border-node-trigger/30',
              title: 'Detect business events',
              description:
                'Stock running low, receipt uploaded, payroll due, expense submitted — anything you can describe.',
            },
            {
              label: 'AI Logic',
              icon: Brain,
              ...
              title: 'Reason and verify',
              description:
                'AI checks legitimacy, predicts risk, learns your patterns, and decides the right action.',
            },
            {
              ...
              description:
                'Transfer funds, send SMS approvals, log audits — all through Squad. No human in the loop unless needed.',
            },
          ].map((s, idx) => {
            const Icon = s.icon;
            return (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {[
            ...
            <div
              key={stat.label}
              className="bg-surface-1 border border-border rounded-xl p-4 text-center"
            >
              <p className="text-2xl sm:text-3xl font-bold text-gradient tracking-tight">
                {stat.value}
              </p>
              <p className="text-[11px] sm:text-[12px] text-text-tertiary mt-1 font-medium">
                {stat.label}
              </p>
            </div>
          ))}
  ...
  const cases = [
    {
      ...
      industry: 'Pharmacies & Retail',
      problem: 'Stockouts cost sales. Expired stock costs cash.',
      solution:
        'Wotmind predicts depletion from sales velocity, drafts the purchase order, and pays the supplier automatically before the shelf goes empty.',
      outcomes: ['↓ 60% stockouts', '↓ 35% expired stock', '↑ 18% margin'],
    },
    {
      icon: Truck,
      color: 'text-accent-amber',
      ...
      problem: 'Fake fuel receipts. Slow reimbursements. No paper trail.',
      solution:
        'Driver snaps a receipt. AI verifies it against vendor history and trip data. If clean, Squad transfers reimbursement in minutes. If suspicious, manager gets SMS for approval.',
      outcomes: ['↓ 80% fraud', '↓ 24h → 5min', 'Full audit trail'],
    },
    {
      icon: Briefcase,
      color: 'text-accent-green',
      ...
      problem: 'Manual payroll. Tax mistakes. Compliance penalties.',
      solution:
        'On payday, Wotmind calculates PAYE/pension/NHF, runs AI risk on each transfer, sends each staffer their net via Squad, and files the audit report.',
      outcomes: ['100% on-time payroll', 'PAYE auto-calculated', 'Zero compliance gaps'],
    },
  ];
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr_auto] gap-5 lg:gap-8 items-start">
                  <div className="flex items-start gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${c.bg}`}
                    >
                  ...
                  <div className="flex flex-wrap lg:flex-col gap-1.5 lg:gap-2">
                    {c.outcomes.map((o) => (
                      <span
                        key={o}
                        className={`text-[11px] font-semibold px-2.5 py-1 rounded-full border ${c.border} ${c.bg} ${c.color} whitespace-nowrap`}
                      >
                        {o}
                      </span>
                    ))}
    ...
    <section className="py-16 sm:py-24 border-b border-border-subtle">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
            The shift: from passive to autonomous
          </h2>
        </div>
  ...
  const steps = [
    {
      ...
      description:
        'Squad for payments. Twilio for SMS. Your inventory or POS data. Wotmind plugs in without ripping anything out.',
    },
    {
      number: '02',
      icon: Workflow,
      ...
      description:
        'Type what you want in plain English. Our AI assembles the nodes — triggers, checks, payouts — on a visual canvas.',
    },
    {
      number: '03',
      icon: Brain,
      title: 'AI reasons through each event',
      description:
        'Pattern learning, anomaly detection, velocity checks, custom rules — every transaction gets a risk score.',
    },
    {
      number: '04',
      icon: ArrowRightLeft,
      ...
      description:
        'Low-risk: Squad pays instantly. Medium: SMS approval. High: full review. You set the thresholds, Wotmind enforces them.',
    },
  ];
    ...
    <section id="how-it-works" className="py-16 sm:py-24 border-b border-border-subtle bg-surface-1/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
            From signup to first autonomous payment in minutes
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                <span className="text-[10px] font-mono font-semibold text-accent-primary/70 mb-3 block">
                  {step.number}
                </span>
...
function Trust() {
  const items = [
    {
      ...
      description:
        'Every transaction gets scored against learned baselines, velocity limits, and your custom rules.',
    },
    {
      icon: ShieldX,
      title: 'Fraud detection',
      description:
        'Duplicate receipts, anomalous amounts, new beneficiaries — caught before money leaves your account.',
    },
    {
      icon: Database,
      title: 'Immutable audit logs',
      description:
        'Every event, every decision, every approval — recorded permanently. Export anytime for compliance.',
    },
    {
      icon: Users,
      title: 'Human approvals',
      description:
        'You set thresholds. Wotmind respects them. SMS approval works on any phone, anywhere.',
    },
    {
      icon: Lock,
      title: 'Squad-powered rails',
      description:
        'Bank-grade payment infrastructure. We never hold your funds — Squad does, with full regulatory backing.',
    },
    {
      icon: Eye,
      title: 'Row-level security',
      description:
        'Multi-tenant isolation enforced at the database level. Your data is yours alone.',
    },
  ];
  ...
  return (
    <section id="trust" className="py-16 sm:py-24 border-b border-border-subtle">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          <span className="inline-block text-[11px] font-semibold uppercase tracking-widest text-accent-green mb-3">
            Trust &amp; security
          </span>
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
            Autonomous, but never out of your control
          </h2>
          <p className="text-text-secondary text-base sm:text-lg leading-relaxed">
...
function FAQ() {
  const faqs = [
    {
      q: 'Is my money safe? Who holds the funds?',
      a: 'Wotmind never holds your funds. All money movement happens through Squad — a regulated, licensed payments provider. Wotmind is the brain; Squad is the bank rail.',
    },
    {
      q: 'Can the AI make a payment without my approval?',
      a: 'Only if you tell it to. You define thresholds (e.g. "auto-approve under ₦10k, require SMS for ₦10k–₦100k, block above ₦500k"). Wotmind enforces them.',
    },
    {
      q: 'What happens if the AI gets it wrong?',
      a: 'Every decision is logged with the full reasoning chain. You can review, dispute, and adjust the rules. The system learns from corrections.',
    },
    {
      q: 'Do I need to write code?',
      a: 'No. Describe the workflow in plain English. Wotmind builds it on a visual canvas. Click "Run" to test, click "Activate" to go live.',
    },
    {
      q: 'How does pricing work?',
      a: 'Free for your first 100 automation runs. Then ₦200 per run on the Starter plan, or fixed monthly on Pro. No setup fees, no contracts.',
    },
    {
      q: 'What about my data and compliance?',
      a: 'Data is stored in Supabase with row-level security. You can export and delete at any time. We comply with NDPR and GDPR principles.',
    },
  ];
    ...
    <section className="py-20 sm:py-28 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-text-secondary text-base sm:text-lg mb-8 max-w-xl mx-auto leading-relaxed">
          Your business doesn&apos;t need another dashboard. It needs an intelligent system
          that thinks, verifies, and acts.
        </p>
